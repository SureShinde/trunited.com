...
getOrgChart.themes = {
    annabel: {
        ...
        image: '<image xlink:href="https://trunited.com/tree/images/affiliate1.png"  x="20" y="-20" height="170" preserveAspectRatio="xMidYMid slice" width="170"/>'
    },
    sara: {
        size: [500, 220],
        toolbarHeight: 46,
...
getOrgChart.prototype.showGridView = function() {
    ...
    for (i = 0; i < this._af.length; i++) {
        ...
        var c = this._af[i];
		if(this.config.displayingFields.indexOf(c) > -1)
		{
			a += "<th>" + c + "</th>";
		}
    }
    ...
    for (var b in this.nodes) {
        ...
        for (j = 0; j < this._af.length; j++) {
			...
			{
				if(c == "pointBalance")
					totalPoint += parseInt(e["pointBalance"]);
				var g = e[c];
				a += "<td>";
				a += g ? g : "&nbsp;";
				a += "</td>"
	...
	//a += "<tr class='get-odd'><td style='text-align:right;' colspan="+(this.config.displayingFields.length - 1)+"><b>Total</b>:</td><td>" + totalPoint + "</td></tr>";
