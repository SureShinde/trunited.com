            ...
            if (!$("colorpicker")) {
                ...
                control.innerHTML =
                    '<div id="colorpicker-div">' + (
                        ...
                        '<div id="colorpicker-hue-container">'
                        + '<img src="' + this.options.IMAGE_BASE + 'hue.png" id="colorpicker-hue-bg-img">'
                        + '<div id="colorpicker-hue-slider"><div id="colorpicker-hue-thumb"><img src="'
                        + this.options.IMAGE_BASE
                        + 'hline.png"></div></div></div>'
                        + '<div id="colorpicker-footer"><span id="colorpicker-value"><input type="hidden" onclick="this.select()" id="colorpicker-value-input" name="colorpicker-value" value=""/></span><button id="colorpicker-okbutton">OK</button></div>';
