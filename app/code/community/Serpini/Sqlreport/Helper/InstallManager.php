		...
		if( version_compare("0.4.0",$actualVersion)>0){
			...
			$instructions = array_merge(
					$instructions,
						...
						,array(array("type" => "insert", "name" => "sqlrpt_setup", "items" =>array(array("sql-column", "name", "cronFilePath"),array("sql-column", "value", mysql_real_escape_string(Mage::getBaseDir('media') . DS . 'serpini_sqlreport'. DS . 'emails')))))
