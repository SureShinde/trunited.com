	...
	*/
    ...
    {	
		try {
			...
			$reportcard = Mage::getModel('monyet_easygiftcard/reportcard');
			$customerId = Mage::getSingleton('customer/session')->getCustomer()->getId();
			$reportcard->setCustomerId($customerId);
			$reportcard->setProductId($productId);
			$reportcard->setOrderId($order->getId());
			$reportcard->setFileName($pdfReportPath);
			$reportcard->setReportReason($reportType);
			$reportcard->setCreatedAt(now());
			$reportcard->save();
