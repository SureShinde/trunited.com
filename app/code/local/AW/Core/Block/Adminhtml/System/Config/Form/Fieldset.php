...
class AW_Core_Block_Adminhtml_System_Config_Form_Fieldset extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= "<tr><td class=\"label\"></td><td class=\"value\">"
            . "<button class=\"scalable\" onclick=\"window.location='"
            . Mage::getSingleton('adminhtml/url')->getUrl('adminhtml/awcore_viewlog/index') . "'\" type=\"button\">"
            . "<span>View log</span></button></td></tr>
        ";
