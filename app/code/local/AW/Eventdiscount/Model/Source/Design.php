...
class AW_Eventdiscount_Model_Source_Design extends AW_Eventdiscount_Model_Source_Abstract
{
    public function toOptionArray()
    {
        ...
        $dir = Mage::getDesign()->getSkinBaseDir(
            array(
                 '_area'    => Mage_Core_Model_Design_Package::DEFAULT_AREA,
                 '_default' => true,
        ...
        $baseScopes = $this->_getBaseScopes();
        $scopes = array_merge($scopes, $baseScopes);
        return $scopes;
    }
    ...
    protected function _getBaseScopes()
    {
        $dir = Mage::getDesign()->getSkinBaseDir(
                array(
                    '_area'    => Mage_Core_Model_Design_Package::DEFAULT_AREA,
        ...
        return $this->_listDirectories($dir);
    }
}