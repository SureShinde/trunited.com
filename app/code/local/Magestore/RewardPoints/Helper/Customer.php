...
//        }
    ...
    public function getProductCredit() {
        return $this->getAccount()->getProductCredit();
    }
    ...
    public function getProductCreditBalanceFormated() {
        return Mage::helper('rewardpoints/point')->formatProductCredit(
            $this->getProductCredit(), $this->getStoreId()
        );
    }
