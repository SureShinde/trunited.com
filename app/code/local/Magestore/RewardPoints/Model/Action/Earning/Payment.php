 ...
 */
class Magestore_RewardPoints_Model_Action_Earning_Payment
    ...
    implements Magestore_RewardPoints_Model_Action_Interface
{
    ...
    {
        return Mage::helper('rewardpoints')->__('Earn points for purchasing order via eCheck payment');
    }

    public function getActionType()
    {
        return Magestore_RewardPoints_Model_Transaction::ACTION_TYPE_RECEIVE_FROM_ECHECK_PAYMENT;
    }
    ...
    {
        $actionObject = $this->getData('action_object');
        return Mage::helper('rewardpoints')->__('Earn points for purchasing order #%s via eCheck payment', $actionObject['order_id']);
    }
