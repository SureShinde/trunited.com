 ...
 */
class Magestore_RewardPoints_Model_Action_Share_Receive
    ...
    implements Magestore_RewardPoints_Model_Action_Interface
{
    ...
    public function getActionLabel() {
        return Mage::helper('rewardpoints')->__('Received truWallet Money from Sharing');
    }

    public function getActionType() {
        return Magestore_RewardPoints_Model_Transaction::ACTION_TYPE_RECEIVE_FROM_SHARING;
    }
