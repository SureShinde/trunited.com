 ...
 */
class Magestore_RewardPoints_Model_Action_Share_Giftcard
    ...
    implements Magestore_RewardPoints_Model_Action_Interface
{
    ...
    public function getActionLabel() {
        return Mage::helper('rewardpoints')->__('Bonus points for transferring affiliate cash to Trunited Gift Card');
    }

    public function getActionType() {
        return Magestore_RewardPoints_Model_Transaction::ACTION_TYPE_RECEIVE_POINTS_FROM_SHARING_GIFT_CARD;
    }
