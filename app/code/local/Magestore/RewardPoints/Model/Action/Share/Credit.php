 ...
 */
class Magestore_RewardPoints_Model_Action_Share_Credit
    ...
    implements Magestore_RewardPoints_Model_Action_Interface
{
    ...
    public function getActionLabel() {
        return Mage::helper('rewardpoints')->__('Sharing truWallet Money');
    }

    public function getActionType() {
        return Magestore_RewardPoints_Model_Transaction::ACTION_TYPE_SHARE;
    }
