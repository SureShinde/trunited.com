 ...
 */
class Magestore_RewardPoints_Model_Action_Reset
    ...
    implements Magestore_RewardPoints_Model_Action_Interface
{
    ...
    public function getProductCredit()
    {
        ...
        return (int)$actionObject->getProductCredit();
    }
    ...
    {
        return Mage::helper('rewardpoints')->__('Reset Points by Admin');
    }
    
    public function getActionType()
    {
        return Magestore_RewardPoints_Model_Transaction::ACTION_TYPE_RESET_POINTS_BY_ADMIN;
    }
    ...
    public function getProductCreditTitle()
    {
        $actionObject = $this->getData('action_object');
        if (!is_object($actionObject)) {
            return '';
        }
        return (string)$actionObject->getData('product_credit_title');
    }
    ...
    public function prepareTransaction()
    {
        ...
        if (is_object($actionObject) && $actionObject->getExpirationDayCredit() && $this->getProductCredit() > 0) {
            $transactionData['expiration_date_credit'] = $this->getExpirationDateCredit($actionObject->getExpirationDayCredit());
        }
