 ...
 */
class Magestore_RewardPoints_Model_Action_Promotion_Order
    ...
    implements Magestore_RewardPoints_Model_Action_Interface
{
    ...
    public function getActionLabel() {
        return Mage::helper('rewardpoints')->__('Received truWallet money for New Customer Promotion - order placed');
    }

    public function getActionType() {
        return Magestore_RewardPoints_Model_Transaction::ACTION_TYPE_RECEIVE_FROM_ORDER_OF_NEW_CUSTOMER;
    }
