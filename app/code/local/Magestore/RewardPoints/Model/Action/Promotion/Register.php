 ...
 */
class Magestore_RewardPoints_Model_Action_Promotion_Register
    ...
    implements Magestore_RewardPoints_Model_Action_Interface
{
    ...
    public function getActionLabel() {
        return Mage::helper('rewardpoints')->__('Received truWallet money for New Customer Promotion.');
    }

    public function getActionType() {
        return Magestore_RewardPoints_Model_Transaction::ACTION_TYPE_RECEIVE_FROM_REGISTER_NEW_CUSTOMER;
    }
