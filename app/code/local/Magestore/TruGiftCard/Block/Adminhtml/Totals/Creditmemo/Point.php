 ...
 */
class Magestore_TruGiftCard_Block_Adminhtml_Totals_Creditmemo_Point
    ...
    public function initTotals()
    {
        ...
        if ($creditmemo->getTrugiftcardEarn() > 0) {
            $totalsBlock->addTotal(new Varien_Object(array(
                'code'  => 'trugiftcard_earn_label',
                'label' => $this->__('Refund truGiftCard Balances'),
                'value' => $creditmemo->getTrugiftcardEarn(),
                'is_formated'   => true,
            )), 'subtotal');
        }
    }
