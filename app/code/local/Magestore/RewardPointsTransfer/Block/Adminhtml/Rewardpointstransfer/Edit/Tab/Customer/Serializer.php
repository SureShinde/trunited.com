...
/**
 * RewardpointsTransfer Customer Grid Serializer Block
 * 
 * @category    Magestore
 * @package     Magestore_RewardPoints
 * @author      Magestore Developer
 */
class Magestore_RewardPointsTransfer_Block_Adminhtml_Rewardpointstransfer_Edit_Tab_Customer_Serializer
    extends Mage_Adminhtml_Block_Template
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('rewardpointstransfer/transfer/customer/serializer.phtml');
        return $this;
    }
