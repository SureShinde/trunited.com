 ...
 * 
 * @category    Magestore
 * @package     Magestore_RewardPointsTranser
 * @copyright   Copyright (c) 2012 Magestore (http://www.magestore.com/)
 * @license     http://www.magestore.com/license-agreement.html
 */

/**
 * RewardpointsTransfer Customer Grid Select Block
 * 
 * @category    Magestore
 * @package     Magestore_RewardPointsTranser
 * @author      Magestore Developer
 */
class Magestore_RewardPointsTransfer_Block_Adminhtml_Rewardpointstransfer_Edit_Tab_Customer
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('point_balance', array(
            ...
            'index'     => 'point_balance',
            'type'      => 'number',
            'renderer'  => 'rewardpointstransfer/adminhtml_rewardpointstransfer_edit_tab_renderer_pointbalance',
        ));
    ...
    {
         return $this->getRequest()->getParam('element');
    }
