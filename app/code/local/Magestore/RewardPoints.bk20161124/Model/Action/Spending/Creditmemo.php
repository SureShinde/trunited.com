    ...
    implements Magestore_RewardPoints_Model_Action_Interface
{
    ...
    {
        return Mage::helper('rewardpoints')->__('Retrieve credits spent on refunded order');
    }
    ...
    public function getTitle()
    {
        ...
        return Mage::helper('rewardpoints')->__('Retrieve credits spent on refunded order #%s', $order->getIncrementId());
    }
    ...
    public function getTitleHtml($transaction = null)
    {
        ...
        return Mage::helper('rewardpoints')->__(
            'Retrieve credits spent on refunded order %s',
