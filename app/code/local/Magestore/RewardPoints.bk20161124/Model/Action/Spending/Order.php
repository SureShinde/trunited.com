    ...
    implements Magestore_RewardPoints_Model_Action_Interface
{
    ...
    {
        return Mage::helper('rewardpoints')->__('Spend credits to purchase order');
    }
    ...
    {
        $order = $this->getData('action_object');
        return Mage::helper('rewardpoints')->__('Spend credits to purchase order #%s', $order->getIncrementId());
    }
    ...
    public function getTitleHtml($transaction = null)
    {
        ...
        return Mage::helper('rewardpoints')->__(
            'Spend credits to purchase order %s',
