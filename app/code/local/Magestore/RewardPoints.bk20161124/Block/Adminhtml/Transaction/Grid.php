...
class Magestore_RewardPoints_Block_Adminhtml_Transaction_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('product_credit', array(
            'header'    => Mage::helper('rewardpoints')->__('Product Credits'),
            'align'     => 'right',
        ...
        $this->addColumn('point_used', array(
            'header'    => Mage::helper('rewardpoints')->__('Product Credits Used'),
            'align'     => 'right',
            'index'     => 'point_used',
            'type'      => 'number',
        ));
        ...
        $this->addColumn('expiration_date', array(
            'header'    => Mage::helper('rewardpoints')->__('Points expires On'),
            'index'     => 'expiration_date',
            'type'      => 'datetime',
        ));

        $this->addColumn('expiration_date_credits', array(
            'header'    => Mage::helper('rewardpoints')->__('Credits expires On'),
            'index'     => 'expiration_date_credits',
            'type'      => 'datetime',
        ));
