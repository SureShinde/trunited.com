...
class Magestore_RewardPointsRule_Block_Adminhtml_Earning_Sales_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
		...
		$fieldset->addField('coupon_code', 'text', array(
			'name' => 'coupon_code',
			'label' => Mage::helper('rewardpointsrule')->__('Coupon Code'),
			'title' => Mage::helper('rewardpointsrule')->__('Coupon Code'),
			'required' => false,
			'style'   => 'width:20%!important',
			'note' => Mage::helper('rewardpointsrule')->__('Used to apply this rule')
		));
