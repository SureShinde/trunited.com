 ...
 */
class Magestore_AffiliateplusBanner_Block_Adminhtml_Banner_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $sourceConfig = array(
            ...
            'name' => 'source_file',
            'required' => $isRequired,
            'note' => $this->__('Supported format: .jpeg, .jpg, .png, .gif, .swf.<br/>An image displayed when the banner is closed.'),
        );
        $widthConfig = array(
        ...
        $heightConfig = array(
            ...
            // 'required'  => true,
            'name' => 'height',
            'note' => 'Specify the size of a small banner showed for better display.',
        ...
        $fieldset->addField('peel_image', 'file', array(
            ...
            'name' => 'peel_image',
            'note' => $this->__('Supported format: .jpeg, .jpg, .png, .gif, .swf.<br/>An image displayed when the banner is opened, or during animation when opening and closing the banner.'),
        ));
        ...
        $fieldset->addField('peel_height', 'text', array(
            ...
            'name' => 'peel_height',
            'note' => 'Specify the size of a large banner showed for better display.',
        ));
