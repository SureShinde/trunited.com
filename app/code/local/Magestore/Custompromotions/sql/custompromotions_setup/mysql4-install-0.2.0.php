...
$installer->addAttribute("customer", "phone_number",  array(
    ...
    "frontend" => "",
    "unique"     => true,
    "note"       => "Mobile number of customers"
...
$installer->run("
    ...
    DROP TABLE IF EXISTS {$this->getTable('customer_verify_mobile')};
    CREATE TABLE {$this->getTable('customer_verify_mobile')} (
    ...
    DROP TABLE IF EXISTS {$this->getTable('mobile_codes')};
    CREATE TABLE {$this->getTable('mobile_codes')} (
...
INSERT INTO {$this->getTable('mobile_codes')} (`id`, `iso`, `name`, `nicename`, `iso3`, `numcode`, `phonecode`) VALUES
