 ...
 */
class Magestore_AffiliateplusTrash_Adminhtml_Affiliateplustrash_TransactionController extends Mage_Adminhtml_Controller_Action {
    ...
    public function deleteAction() {
        ...
        if ($transactionId > 0) {
            ...
            try {
                ...
                return $this->_redirect('adminhtml/affiliateplus_transaction/view', array('id' => $transactionId));                 //Changed By Adam 29/10/2015: Fix issue of SUPEE 6788 - in Magento 1.9.2.2
            }
        }
        $this->_redirect('adminhtml/affiliateplus_transaction/index');                         //Changed By Adam 29/10/2015: Fix issue of SUPEE 6788 - in Magento 1.9.2.2
    }
    ...
    protected function _isAllowed() {
        return Mage::getSingleton('admin/session')->isAllowed('affiliateplus/trash/transaction');
    }
