...
abstract class Indies_Recurringandrentalpayments_Model_Web_Service_Client_Nvp_Abstract extends Indies_Recurringandrentalpayments_Model_Web_Service_Client
{
     ...
     * @return Indies_Recurringandrentalpayments_Model_Web_Service_Client_Nvp_Abstract
     */
    ...
    public function runRequest()
    {
        ...
        if (!$httpResponse) {
            throw new Indies_Recurringandrentalpayments_Exception("NVP Request failed: " . curl_error($ch) . '(' . curl_errno($ch) . ')', print_r($this->getRequest()->getData(), 1));
        }
