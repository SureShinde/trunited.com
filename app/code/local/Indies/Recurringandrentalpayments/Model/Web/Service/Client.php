...
abstract class Indies_Recurringandrentalpayments_Model_Web_Service_Client extends Varien_Object
{

    /**
     * Initializes request model for web client.
     * @return Indies_Recurringandrentalpayments_Model_Web_Service_Client_Request_Simple
     */
    public function getRequest()
    {
        if (!$this->getData('request')) {
            $this->setRequest(Mage::getModel('recurringandrentalpayments/web_service_client_request_simple'));
        }
     ...
     * @return Indies_Recurringandrentalpayments_Model_Web_Service_Client_Response_Simple
     */
    public function getResponse()
    {
        if (!$this->getData('response')) {
            $this->setResponse(Mage::getModel('recurringandrentalpayments/web_service_client_response_simple'));
        }
