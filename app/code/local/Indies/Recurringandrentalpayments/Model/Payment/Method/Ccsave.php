...
class Indies_Recurringandrentalpayments_Model_Payment_Method_Ccsave extends Indies_Recurringandrentalpayments_Model_Payment_Method_Abstract
{
    ...
    public function processOrder(Mage_Sales_Model_Order $PrimaryOrder, Mage_Sales_Model_Order $Order = null)
    {
        ...
        throw newIndies_Recurringandrentalpayments_Exception("Suspending subscription till order status change to completed");
    }
