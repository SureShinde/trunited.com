...
class Indies_Recurringandrentalpayments_Model_Product_Type_Virtual_Price extends Mage_Catalog_Model_Product_Type_Price
{
    ...
    public function getPrice($product)
    {
        ...
        if ($this->getPriceModel()->isSubscriptionPriceSet($product) ) {
