...
class Indies_Recurringandrentalpayments_Model_Sales_Order_Pdf_Items_Downloadable_Creditmemo extends Mage_Downloadable_Model_Sales_Order_Pdf_Items_Creditmemo
{
            ...
            if ($type && $starttime) {
                ...
                if ($periodTypeId && $periodStartDate) {
                    ...
                    $result[] = array(
                        ...
                        'value' => $peMage::helper('core')->formatDate($periodStartDate, Mage_Core_Model_Locale::FORMAT_TYPE_LONG)
                    );
                }
            }
