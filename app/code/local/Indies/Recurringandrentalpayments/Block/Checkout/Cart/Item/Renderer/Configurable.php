...
class Indies_Recurringandrentalpayments_Block_Checkout_Cart_Item_Renderer_Configurable extends Mage_Checkout_Block_Cart_Item_Renderer_Configurable
{
    ...
    public function getOptionList()
    {
        ...
        if (file_exists(Mage::getBaseDir() . '/app/code/core/' . 'Mage/Catalog/Helper/Product/Configuration.php')) {
            ...
            return array_merge($this->_getRnrOptions(), $attributes, $helper->getCustomOptions($item));
        }
        else
