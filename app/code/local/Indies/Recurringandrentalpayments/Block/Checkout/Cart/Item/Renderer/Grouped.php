...
class Indies_Recurringandrentalpayments_Block_Checkout_Cart_Item_Renderer_Grouped extends Mage_Checkout_Block_Cart_Item_Renderer_Grouped
{
    protected function _getRnrOptions()
    {
      ...
      //	$plan = Mage::getModel('recurringandrentalpayments/plans')->load($terms->getPlanId(),'plan_id');
