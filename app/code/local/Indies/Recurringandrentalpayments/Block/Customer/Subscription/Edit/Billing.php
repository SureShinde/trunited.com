...
class Indies_Recurringandrentalpayments_Block_Customer_Subscription_Edit_Billing extends Mage_Directory_Block_Data
{
    ...
    {
        return Mage::getUrl('recurringandrentalpayments/customer/save', array('section' => 'billing', 'id' => $this->getRequest()->getParam('id')));
    }
